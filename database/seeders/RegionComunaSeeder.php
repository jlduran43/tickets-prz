    ...
    public function run(): void
    {
        ...
        foreach ($regiones as $datosRegion) {
            $region = Region::query()->updateOrCreate(
                ['codigo' => $datosRegion['codigo']],
                [
                    'nombre' => $datosRegion['nombre'],
                    'activo' => true,
                ]
            );

            foreach ($datosRegion['comunas'] as $datosComuna) {
                Comuna::query()->updateOrCreate(
                    ['codigo' => $datosComuna['codigo']],
                    [
                        'region_id' => $region->id,
                        'nombre' => $datosComuna['nombre'],
                        'activo' => true,
                    ]
                );
            }
